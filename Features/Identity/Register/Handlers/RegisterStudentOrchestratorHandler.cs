...
public class RegisterStudentOrchestratorHandler(
    IEmailService emailService,
    IPasswordHasher passwordHasher,
    IOtpService otpService,
    IMediator mediator) : IRequestHandler<RegisterStudentOrchestrator, RequestResponse<RegisterResponse>>
{
    public async Task<RequestResponse<RegisterResponse>> Handle(RegisterStudentOrchestrator request, CancellationToken cancellationToken)
    {
